...
def add_roles():
    ...
    red = Status(name = "Закрыта", color = "red")
    green = Status(name = "Открыта", color = "green")
    blue = Status(name = "Принята", color = "green")
    lightblue = Status(name = "Отменена", color = "blue")
    orange = Status(name = "Просрочена реакция", color = "orange")
    purple = Status(name = "Архив", color = "purple")


    #db.session.add(admin_role)
    #db.session.add(user_role)
    #db.session.add(executor_role)
    db.session.add(lightblue)
    db.session.add(red)
...
def tickets():
    ...
    #tickets = session.query(Task).join(Status).all()
